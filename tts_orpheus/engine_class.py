...
class OrpheusModel:
    ...
    def generate_tokens_sync(self, prompt, voice=None, request_id=uuid.uuid4().hex, temperature=0.6, top_p=0.8, max_tokens=8192, stop_token_ids = [49158], repetition_penalty=1.3):
